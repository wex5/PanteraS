...
# Defaults for stand alone mode,EDGE mode offer a pulibc access
MASTER=${MASTER:-"true"}
SLAVE=${SLAVE:-"true"}
EDGE=${EDGE:-"true"}
...
#OPTIONAL
START_DNSMASQ=${START_DNSMASQ:-${SLAVE}}
...
# Enable keepalived if the consul_template gets started and a
